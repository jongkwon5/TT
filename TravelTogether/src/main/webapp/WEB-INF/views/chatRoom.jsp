	...
	<div id="main">
		<div class="swiper mySwiper" style="margin:0px;">
			<div class="swiper-wrapper">
				<div class="swiper-slide" style="background-image: url(${context}/resources/image/chatRoom/ad_1.png"
					 )></div>
				<div class="swiper-slide" style="background-image: url(${context}/resources/image/chatRoom/ad_2.png"
					 )></div>
				<div class="swiper-slide" style="background-image: url(${context}/resources/image/chatRoom/ad_3.png"
					 )></div>
				<div class="swiper-slide" style="background-image: url(${context}/resources/image/chatRoom/ad_4.png"
					 )></div>
			</div>
		</div>
		<div id="chatMain">
