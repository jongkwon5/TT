...
<body>
<div id="container"
     style="background: url(../image/main/main_middle_background.png) 50% center no-repeat rgb(237, 245, 212);">
    <div class="box">
        ...
        <div class="chatListBox">
            ...
            <table>
                ...
                <c:when test="${empty chatRoomList}">
                    <tr>
                        <td colspan="5"
                            style="height: 580px; text-align: center; background-image:url('${context}/resources/image/chatRoom/chatRoomEmpty.png');
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="#" data-chat-number="${chatRoomList.chatNumber}"
                                   data-chat-password="${chatRoomList.chatPassword}"
                                   data-chat-title="${chatRoomList.chatTitle}"
                                   data-chat-member_id="${sessionScope.userId}">
                                    <span class="region-button">${chatRoomList.chatRegion}</span>
                                        ${chatRoomList.chatTitle}
