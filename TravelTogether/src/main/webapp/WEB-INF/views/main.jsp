    ...
    <div class="main-bottom-section"><!-- main-bottom-grid -->
        <div id="bottom-grid" class="bottom-grid1">
            <c:forEach items="${festivalRandomList}" var="festivalRandom">
                <div class="grid">
                    <c:set var="imagePath"
                           value="${context}/resources/image/festival/${festivalRandom.festival_name}/${festivalRandom.festival_name}_1_공공3유형"/>
                    <div class="grid-img"
                         onclick="location.href='getFestival.do?festival_name=${festivalRandom.festival_name}'"
                         style="background-image:url('${imagePath}.png'), url('${imagePath}.jpg');"></div>
        ...
        <div id="bottom-grid" class="bottom-grid2" style="display: none;"> <!-- TT 추천 -->
            <c:forEach items="${festivalLikeList}" var="festivalLike">
                <div class="grid">
                    <c:set var="imagePath"
                           value="${context}/resources/image/festival/${festivalLike.festival_name}/${festivalLike.festival_name}_1_공공3유형"/>
                    <div class="grid-img"
                         onclick="location.href='getFestival.do?festival_name=${festivalLike.festival_name}'"
                         style="background-image:url('${imagePath}.png'), url('${imagePath}.jpg');"></div>
